...
PREDICTOR_PATH =  "/home/rnative/Desktop/hair_ai_new_10nov/myapp/stargan2/shape_predictor_68_face_landmarks.dat"
# PREDICTOR_PATH =  "/home/ubuntu/celebrity_model-master/myapp/stargan2/shape_predictor_68_face_landmarks.dat"
...
# In[164]:
def main(image_path,color_code,save_path):
    ...
    maskSmall = cv2.dilate(maskSmall, (5, 5))
    ...
    # b, g, r = lipstick_colors      #[10, 50, 250]       # [10, 250, 10]
    ...
    masked_lips = cv2.bitwise_and(im, im, mask=mask[:, :, 0])
    # plt.imshow(masked_lips[:,:,::-1])
    # plt.title('masked_lips')
    # plt.show()

    # plt.imshow(color_mask[:, :, ::-1])
...
# image_path='imgs/18.jpg'
# color_code={"vamptastic_plum": (103, 92, 223)}
