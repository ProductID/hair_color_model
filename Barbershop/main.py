...
if __name__ == "__main__":
    ...
    parser.add_argument('--im_path1', type=str, default='912.png', help='Identity image')# the image which hair color required to change
    parser.add_argument('--im_path2', type=str, default='912.png', help='Structure image') # which adopt the hair style (therefor image1 and image2 both are same)
    parser.add_argument('--im_path3', type=str, default='1141.jpg', help='Appearance image') ## refrence image color
