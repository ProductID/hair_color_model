...
if __name__ == "__main__":
    ...
    parser.add_argument('--im_path1', type=str, default='120.png', help='Identity image')# the image which hair color required to change
    parser.add_argument('--im_path2', type=str, default='120.png', help='Structure image') # which adopt the hair style (therefor image1 and image2 both are same)
    parser.add_argument('--im_path3', type=str, default='120.png', help='Appearance image') ## refrence image color
    ...
    for ref_img in ref_img_lis:
        new_d = {'input_dir': 'input/face', 'output_dir': 'output', 'im_path1': '912.png', 'im_path2': '912.png',
                 'im_path3': ref_img,
                 'sign': 'realistic', 'smooth': 5, 'size': 1024, 'ckpt': 'pretrained_models/ffhq.pt',
