...
from Barbershop.utils.image_utils import load_image, dilate_erosion_mask_path, dilate_erosion_mask_tensor
...
class Blending(nn.Module):
    ...
    def load_segmentation_network(self):
        ...
        print(self.opts.seg_ckpt,'llllllllllllllllllllllllllllllll')
    ...
    def blend_images(self, img_path1, img_path2, img_path3, sign='realistic'):
        ...
        output_image_path=self.save_blend_results(im_name_1, im_name_2, im_name_3, sign, I_G, latent_mixed, latent_F_mixed)
